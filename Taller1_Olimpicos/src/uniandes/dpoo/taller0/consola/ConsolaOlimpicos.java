...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("14. Adición taller 0; buscar el país de un atleta por su nombre\n");
	}

	/**
	 * Taller 0. Busca el país de un atleta por el nombre del atleta
	 */
	private void ejecutarBuscarPaisAtleta()
	{
		String persona = input ("Nombre del atleta a consultar: \n");
		
		String paiis = calculadora.PaisAtleta(persona);
		
		System.out.println(paiis);
